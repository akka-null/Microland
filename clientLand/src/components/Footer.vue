...
<footer class="py-6 md:px-8 md:py-0">
    <div class="container flex flex-col items-center justify-between gap-4 md:h-24 md:flex-row">
        <div class="text-center text-sm leading-loose text-muted-foreground md:text-left">
            <span class="inline-block"> Built by <a href="https://x.com/akka_null/" target="_blank" class="underline underline-offset-4 font-bold decoration-foreground"> akka </a></span>
            <span class="ml-0.5">.</span>
            <span class="inline-block"><a href="https://github.com/akka-null/" target="_blank" >
