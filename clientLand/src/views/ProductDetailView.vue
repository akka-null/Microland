...
<template>
  ...
  <section class="py-12">
    <div class="container mx-auto">
      <div
        class="lg:col-gap-2 xl:col-gap-2 mt-8 grid grid-cols-8 gap-2 lg:mt-12 lg:grid-cols-8 lg:gap-2"
      >
        <!-- first half -->
        <div class="lg:col-span-4 lg:row-span-1 lg:row-end-1">
          ...
          <div class="mt-5 flex items-center">
            <div class="flex items-center" v-for="i in 5" :key="i">
              ...
              <div v-else>
                <svg
                  class="block h-4 w-4 align-middle text-gray-500"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
          ...
          >
            ...
            <button
              @click="store.addToCart(store.product, getQnty())"
              type="submit"
              ...
              <Carousel class="relative w-full max-w-xs" @init-api="(val) => (emblaMainApi = val)">
                <CarouselContent>
                  ...
                  >
                    <div class="p-1">
                      <img
                        class="hover:scale-150 transition-all duration-200 cursor-pointer"
                        :src="image"
                        alt=""
                      />
                    </div>
          ...
          <div class="flex gap-4">
            ...
            >
              ...
              <span
                ...
                >{{ store.product.reviewsCount }}</span
              >
              <span
                class="ml-2 block rounded-full bg-gray-500 px-2 py-px text-xs font-bold text-gray-100"
                >Login To Add Yours</span
              >
            </div>
          </div>
        </div>
