...
const res = await axios.post(`https://microland.vercel.app/api/forget`, { email: "abdennourbeztout@gmail.com" });
console.log(res);
}
</script>
...
<template>
    <div class="flex justify-center">
        <form class="w-2/3 space-y-6" @submit="onSubmit">
            ...
            <router-link @click="akka" to="#">
                <h4 class="text-gray-500">forget password vercel version wanna seee ?</h4>
            </router-link>
            <Button type="submit">
                Login
            </Button>
            <router-link to="/register" class="px-2">
                <Button variant="outline" class="font-semibold text-blue-500">
                    Create an Account
                </Button>
            </router-link>
        </Form>
