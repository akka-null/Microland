...
export const NavigationItems = [
  {
    type: { title: 'parts', href: `${PART_URL}`, path: 'Part' },
    category: [
  ...
  {
    type: { title: 'Computer', href: `${COMPUTER_URL}`, path: 'Computer' },
    category: [
  ...
  {
    type: { title: 'Peripheral', href: `${PERIPHERAL_URL}`, path: 'Peripheral' },
    category: [
      ...
      { title: 'Mouse Pad', href: `${PERIPHERAL_URL}/MousePad`, path: 'MousePad' },
      {
        ...
        href: `${PERIPHERAL_URL}/Keyboard-Mouse`,
        path: 'Keyboard-Mouse'
      },
